...
<head>
    ...
    <title>Ijin Absen | Sign Up </title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?=site_url('sign_up/process')?>"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="password" name="password" min="5" max="10" class="form-control"
                                        ...
                                        <div class="col-12">
                                            <label for="yourPassword" class="form-label">Password Konfirmasi</label>
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend"><i
                                                        class="bi bi-spellcheck"></i></span>
                                                <input type="password" name="passconfirm" min="5" max="10" class="form-control"
                                                    id="yourPassword" required>
                                        ...
                                        <div class="col-12">
                                            <button name="add" id="#sign_up" class="btn btn-primary w-100"
                                                type="submit">Create
                                                Account</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Sudah punya akun? <a
                                                    href="<?=site_url('auth/sign_in')?>">Sign In</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
